...
_veh addItemCargoGlobal ["ACE_salineIV",8];
...
_veh addItemCargoGlobal ["ACE_CableTie",4];
...
_veh addItemCargoGlobal ["ACE_NVG_Wide",1];
...
_veh addMagazineCargoGlobal ["tf47_m3maaws_HEDP",4];
_veh addMagazineCargoGlobal ["tf47_m3maaws_HEAT",2];
_veh addMagazineCargoGlobal ["tf47_m3maaws_HE",4];
_veh addMagazineCargoGlobal ["tf47_m3maaws_SMOKE",2];
_veh addMagazineCargoGlobal ["HandGrenade",4];
_veh addMagazineCargoGlobal ["SmokeShellPurple",2];
_veh addMagazineCargoGlobal ["SmokeShellGreen",2];
_veh addMagazineCargoGlobal ["SmokeShell",6];
_veh addMagazineCargoGlobal ["rhs_mag_mk84",2];
_veh addMagazineCargoGlobal ["DemoCharge_Remote_Mag",4];
_veh addMagazineCargoGlobal ["SLAMDirectionalMine_Wire_Mag",2];
_veh addMagazineCargoGlobal ["APERSTripMine_Wire_Mag",2];
_veh addMagazineCargoGlobal ["rhsgref_mag_rkg3em",1];
_veh addMagazineCargoGlobal ["ACE_HuntIR_M203",4];
_veh addMagazineCargoGlobal ["rhs_mag_m713_Red",4];

// weapons go here 
_veh addWeaponCargoGlobal ["hlc_rifle_falosw",2];
